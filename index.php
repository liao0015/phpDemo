...
<body>
	...
	<nav class="nav-main">
		<ul>
			...
			<li id="tab-selectfile"><span>Select files</span></li>
...
<form action="send.php" method="POST" enctype="multipart/form-data">
	...
	<div id="fileupload-wrapper">
		<div id="rawfile-button-wrapper">
			<div id="open-select-rawfile-label">
				<label>Select Raw Files</label>
			</div>
		...
		<div id="selected-rawfile-list-wrapper"></div>
		<!-- select raw files -->
